...
const CLI_Command_Definition_t xHelpCommand2 =
{
	"?",
	"",
	prvHelpCommand,
...
added to this list. */
static CLI_Definition_List_Item_t xRegisteredCommands2 =
{
	&xHelpCommand2,	/* The first command in the list is always the help command, defined in this file. */
	NULL            /* The next pointer is initialised to NULL, as there are no other registered commands yet. */
};
static CLI_Definition_List_Item_t xRegisteredCommands =
{
	&xHelpCommand,	/* The first command in the list is always the help command, defined in this file. */
	&xRegisteredCommands2 /* The next pointer is initialised to NULL, as there are no other registered commands yet. */
};
...
{
static CLI_Definition_List_Item_t *pxLastCommandInList = &xRegisteredCommands2;
