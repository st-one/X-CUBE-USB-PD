...
/** 
  * @brief  STUSB1602 Status structures definition  
  */  
typedef enum 
{
  STUSB1602_OK       = 0x00,
  STUSB1602_ERROR    = 0x01,
  STUSB1602_BUSY     = 0x02,
  STUSB1602_TIMEOUT  = 0x03
...
/*************************************************************************************************************
  ...
  * @Address: 	11h
  * @Access: 	RO
  * @Note: 	This register provides information on the connection state with respect to the Type-C FSM states 
...
/************************************************************************************************************
  ...
  * @Address: 	17h
  * @Access: 	RC
  * @Note: 	This register provides information on hardware PHy status condition 
  ************************************************************************************************************/ 
typedef union
{
  uint8_t d8;
...
/************************************************************************************************************
  ...
  * @Address: 	1Eh
  * @Access: 	R/W
  * @Note: 	This register allows to change the default current limit of the power switches 
...
/************************************************************************************************************
  ...
  * @Address: 	20h
  * @Access: 	R/W
  * @Note: 	This register allows to modify the default voltage monitoring conditions for VCONN. 
  *
  *		Disabling the UVLO threshold detection on VCONN pin is deactivating the VCONN power path 
...
/************************************************************************************************************
  ...
  * @Address: 	21h
  * @Access: 	R/W
  * @Note: 	This register contains the parameters used for VBUS monitoring voltage.
  ************************************************************************************************************/
typedef union
{
  uint8_t d8;
...
/************************************************************************************************************
  ...
  * @Address: 	22h
  * @Access: 	R/W
  * @Note: 	This register contains the parameters used to shift the VBUS monitoring voltage range.
  ************************************************************************************************************/ 
typedef union
{
  uint8_t d8;
...
/************************************************************************************************************
  ...
  * @Address: 	24h
  * @Access: 	R/W
  * @Note: 	This register controls the powered accessory detection and operation modes when the device 
...
/************************************************************************************************************
  ...
  * @Address: 	25h
  * @Access: 	R/W
  * @Note: 	This register contains the parameter used to define the VBUS discharge time when the VBUS discharge path is activated).
  ************************************************************************************************************/ 
typedef union
{
  uint8_t d8;
...
/************************************************************************************************************
  ...
  * @Address: 	26h
  * @Access: 	R/W
  * @Note: 	This register controls the activation of the VBUS discharge path.
  ************************************************************************************************************/ 
typedef union
{
  uint8_t d8;
...
typedef struct
{
  STUSB1602_ALERT_STATUS_RegTypeDef                     reg_0B;
  STUSB1602_ALERT_STATUS_MASK_reg_TypeDef               reg_0C;
  STUSB1602_CC_DETECTION_STATUS_TRANS_RegTypeDef        reg_0D;
  STUSB1602_CC_DETECTION_STATUS_RegTypeDef              reg_0E;
  STUSB1602_MONITORING_STATUS_TRANS_RegTypeDef          reg_0F;
  STUSB1602_MONITORING_STATUS_RegTypeDef                reg_10;
  STUSB1602_CC_CONNECTION_STATUS_RegTypeDef             reg_11;
  STUSB1602_HW_FAULT_STATUS_TRANS_RegTypeDef            reg_12;
...
/**
  * @brief USB PD SINK_POWER_STATE structures definition
  * @Address: 11h - Bit6:5
  * @Access: RO
  */
typedef enum
...
/**
  * @brief USB PD Type-C FSM State structures definition
  * @Address: 11h - Bit4:0
  * @Access: RO
  */
typedef enum
{
  ...
  ErrorRecovery                         = 19,
  TryDebounce_SNK                       = 20, /* (Intermediate state towards Try.SNK state) */
  Try_SNK                               = 21,
  TryWait_SRC                           = 23,
...
/*0x12*/
/**
  * @brief USB PD Thermal_Fault structures definition
  * @Address: 12h - Bit7
  * @Access: RC
  */
typedef enum
...
/**
  * @brief USB PD VPU_OVP_Fault_Transition structures definition
  * @Address: 12h - Bit5
  * @Access: RC
  */
typedef enum
...
/**
  * @brief USB PD VPU_Presence_Transition structures definition
  * @Address: 12h - Bit4
  * @Access: RC
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SW_RVP_FAULT_TRANS structures definition
  * @Address: 12h - Bit2
  * @Access: RC
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SW_OCP_FAULT_TRANS structures definition
  * @Address: 12h - Bit1
  * @Access: RC
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SW_OVP_FAULT_TRANS structures definition
  * @Address: 12h - Bit0
  * @Access: RC
  */
typedef enum
...
/*0x13*/
/**
  * @brief USB PD VPU_OVP_Fault structures definition
  * @Address: 13h - Bit7
  * @Access: RO
  */
typedef enum
...
/**
  * @brief USB PD VPU_Presence structures definition
  * @Address: 13h - Bit6
  * @Access: RO
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SW_RVP_FAULT_CC1 structures definition
  * @Address: 13h - Bit5
  * @Access: RO
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SW_RVP_FAULT_CC2 structures definition
  * @Address: 13h - Bit4
  * @Access: RO
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SW_OCP_FAULT_CC1 structures definition
  * @Address: 13h - Bit3
  * @Access: RO
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SW_OCP_FAULT_CC2 structures definition
  * @Address: 13h - Bit2
  * @Access: RO
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SW_OVP_FAULT_CC1 structures definition
  * @Address: 13h - Bit1
  * @Access: RO
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SW_OVP_FAULT_CC2 structures definition
  * @Address: 13h - Bit0
  * @Access: RO
  */
typedef enum
...
/*0x17*/
/**
  * @brief Bus_Idle structures definition
  * @Address: 17h - Bit3
  * @Access: RC
  */
typedef enum
...
/*0x18*/
/**
  * @brief USB PD CC_CURRENT_ADVERTISED structures definition
  * @Address: 18h - Bit7:6
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD SNK_DISCONNECT_MODE structures definition
  * @Address: 18h - Bit5
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD CC_VCONN_DISCHARGE_EN structures definition
  * @Address: 18h - Bit4
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD DR_SWAP_EN structures definition
  * @Address: 18h - Bit3
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD PR_SWAP_EN structures definition
  * @Address: 18h - Bit2
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD VCONN_SWAP_EN structures definition
  * @Address: 18h - Bit1
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD CC_VCONN_SUPPLY_EN structures definition
  * @Address: 18h - Bit0
  * @Access: R/W
  */
typedef enum
...
/*0x1E*/
/**
  * @brief USB PD CC_VCONN_SWITCH_CTRL structures definition
  * @Address: 1Eh - Bit3:0
  * @Access: R/W
  */
typedef enum
...
/*0x1F*/
/**
  * @brief USB PD TYPE-C_CTRL structures definition
  * @Address: 1Fh - Bit7:4
  * @Access: R/W
  */
typedef enum
...
/*0x20*/
/**
  * @brief USB PD VCONN_MONITORING_EN structures definition
  * @Address: 20h - Bit7
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD VCONN_UVLO_THRESHOLD structures definition
  * @Address: 20h - Bit6
  * @Access: R/W
  */
typedef enum
...
/*0x24*/
/**
  * @brief USB PD PWR_ACC_TRY_SNK_EN structures definition
  * @Address: 24h - Bit1
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD PWR_ACC_DETECT_EN structures definition
  * @Address: 24h - Bit0
  * @Access: R/W
  */
typedef enum
...
/*0x26*/
/**
  * @brief USB PD VBUS_DISCHARGE_CTRL structures definition
  * @Address: 26h - Bit7
  * @Access: R/W
  */
typedef enum
...
/*0x27*/
/**
  * @brief USB PD VBUS_SINK_EN structures definition
  * @Address: 27h - Bit1
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD VBUS_SOURCE_EN structures definition
  * @Address: 27h - Bit0
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD POWER_MODE structures definition
  * @Address: 28h - Bit2:0
  * @Access: R/W
  */
typedef enum
...
/*0x2E*/
/**
  * @brief USB PD VDD_OVLO_DISABLE structures definition
  * @Address: 2Eh - Bit6
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD VBUS_RANGE_DISABLE structures definition
  * @Address: 2Eh - Bit4
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD VBUS_VSAFE0V_THRESHOLD structures definition
  * @Address: 2Eh - Bit2:1
  * @Access: R/W
  */
typedef enum
...
/**
  * @brief USB PD VDD_UVLO_DISABLE structures definition
  * @Address: 2Eh - Bit0
  * @Access: R/W
  */
typedef enum
